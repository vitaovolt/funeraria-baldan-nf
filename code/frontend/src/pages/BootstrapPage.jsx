  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-5 py-12">
      ...
      <p className="mt-2 text-[var(--muted)]">
        Bootstrap F0 — API Laravel + SPA React. PDV, estoque e NFC-e entram nas próximas fases.
      </p>

      <section className="mt-8 rounded-[10px] border border-[var(--line)] bg-[var(--surface)] p-4 shadow-[0_10px_30px_rgba(13,42,92,0.08)]">
        ...
        {error ? (
          ...
          <>
            ...
            <pre className="mt-2 overflow-auto rounded-lg bg-[var(--brand-primary)] p-3 text-xs text-white">
